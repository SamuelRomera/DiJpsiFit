...
def unbinned_func(qt_array, Q, c1, c2, c3):
...
def main():
    ...
    # Save with pickle
    with open("computed_results.pkl", "wb") as f:
        pickle.dump(result_dict, f)

    end = time.time()

    print(f"Execution time: {end - start:.4f} seconds")
    print("All results computed and saved to computed_results.pkl")
